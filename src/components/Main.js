...
// 获取图片相关的数据
imagesDatas = (function genImagesURL(imagesDatasArr){
	for (let i = 0; i < imagesDatasArr.length; i++) {
		let singleData = imagesDatasArr[i];
...
class ImgFigure extends React.Component {
	...
	componentDidMount(){
		this.scrollWidth = this.refs.img.scrollWidth;
		this.scrollHeight = this.refs.img.scrollHeight;
	}
	render(){
	  	var styleObj = {};
	    ...
	    return (
	      <figure className="img-figure" style={styleObj} ref='img'>
